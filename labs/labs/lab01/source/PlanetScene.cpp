...
namespace lab5
{
    PlanetScene::PlanetScene() :
        ...
        mSun("sun.jpg")
    {
        mSun.setPosition({ 5.0f, 0.0f, 5.0f });
        mEarth.setPosition({ 15.0f, 0.0f, 15.0f });
    ...
    void PlanetScene::renderScene()
    {
        ...
        mProjection = glm::perspective(
            glm::radians(mCamera.getCameraFOV())+1,
        ...
        {  //mEarth.setPosition({ 20.0f, 0.0f, 20.0f });
           // mEarth.setVelocity({25.0f, 0.0f, 25.0f});
